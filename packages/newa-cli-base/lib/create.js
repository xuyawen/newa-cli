...
async function create(name) {
    ...
    answers.features.forEach(feature => {
        if (feature !== 'service') {
            pkg.devDependencies[`newa-cli-plugin-${feature}`] = '~1.0.0'
        } else {
            pkg.devDependencies['newa-cli-service'] = '~1.0.0'
        }
    })
    ...
    answers.features.forEach(feature => {
        if (feature !== 'service') {
            require(`newa-cli-plugin-${feature}/generator`)(generator, answers)
        } else {
            require(`newa-cli-service/generator`)(generator, answers)
        }
    })
